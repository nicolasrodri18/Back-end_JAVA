...
-- =====================================================================
-- Base_De_datos_MGM_Solutions_(BETA).sql
-- Script de creación de la base de datos para MGM Solutions.
-- Define tablas de usuarios, roles, inventario, ventas y relaciones.
-- =====================================================================
...
-- 8. TBL_Almacen (Gestión de inventario físico por empresa)
...
-- 11. TBL_RELACION_LABORAL (Vínculo oficial entre Empleado y Empresa)
